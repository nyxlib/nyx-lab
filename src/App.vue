...
<template>
    ...
    <div class="d-flex flex-row nyx-bg1" style="height: calc(100% - 3.0rem + 1px); width: 100%;">
        ...
        <ul class="nav nav-pills flex-column flex-nowrap overflow-x-hidden overflow-y-scroll nyx-bg2 px-2" style="width: 4.5rem;" id="nyx_menu">

            <!-- *************************************************************************************************** -->

            <li class="nav-item" title="Control panel" v-tooltip>
                <router-link class="nav-link rounded-1 mt-0" active-class="active" to="/home" style="padding: 0.8rem 1.0rem;">
            ...
            <li class="nav-item" title="Configuration" v-tooltip>
                <router-link class="nav-link rounded-1 mt-2" active-class="active" to="/config" style="padding: 0.8rem 1.0rem;">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 16 16">
