...
const _buildElectronRuntime = () => ({
    ...
    save: (defaultPath, typeMime, typeName, typeExts, text) => globalThis.__ELECTRON__.save(defaultPath, typeMime, typeName, typeExts, text),

    /*----------------------------------------------------------------------------------------------------------------*/
    /* FILES                                                                                                          */
    /*----------------------------------------------------------------------------------------------------------------*/

    read: (fileName) => globalThis.__ELECTRON__.read(fileName),

    /*----------------------------------------------------------------------------------------------------------------*/

    write: (fileName, text) => globalThis.__ELECTRON__.write(fileName, text),
    ...
    exec: (cmd, args) => globalThis.__ELECTRON__.exec(cmd, args),
