...
const search = () => {
    ...
    const state_objectName = state.objectName.trim().toUpperCase();
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control form-control-sm" type="text" id="A9856A65" placeholder="Messier, NGC or HIP object" v-no-autocomplete v-model="state.objectName" @keyup.enter="search()" />
                        </div>

                        <div class="mb-3">
                            <label class="form-label" for="E279F652">Observation date</label>
                            <input class="form-control form-control-sm" type="date" id="E279F652" placeholder="Observation date" v-no-autocomplete v-model="state.observationDate" @change="update()" />
                        </div>
