    ...
    <nav class="navbar navbar-expand bg-primary border-bottom py-0">
        <div class="container-fluid px-3" data-tauri-drag-region>
            ...
            <div class="d-flex ms-auto py-1">
                ...
                <button class="btn btn-sm btn-warning" type="button" v-if="!indiStore.isConnected">
                    <i class="bi bi-lightning-charge"></i>
                </button>
    ...
    <div class="d-flex" style="height: calc(100% - 2.5rem - 1px);">
        ...
        <div class="d-flex flex-column" style="height: 100%; width: 4.5rem; overflow-y: scroll;">
            ...
            <ul class="nav nav-pills flex-grow-1 flex-column justify-content-start text-center border-end">
                ...
                <li class="nav-item" title="Sky map" v-tooltip>
                ...
                <li class="nav-item" title="Node-RED" v-tooltip>
